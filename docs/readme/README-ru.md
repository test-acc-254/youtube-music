...
- **Тёмная тема**: Включает комплексную тёмную тему для интерфейса приложения. При включении автоматически отключает тему цвета альбома во избежание конфликтов
